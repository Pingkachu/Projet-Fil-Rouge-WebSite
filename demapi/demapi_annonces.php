...
<html>
	...
	<?php
			...
			$resultat = $bdd->query('SELECT * FROM demapi.annonces ORDER BY date_annonce LIMIT 0, 4');
...
?>
				<div class = "annonce">
						...
						<p class="description">
							...
							<strong><?php echo 'Téléphone : ';?></strong><?php echo '0'.$donnees['telephone'].'<br/>';?>
...
?>
			...
			<a class = "lien_suivant" href = "demapi_annonces_next.php">Page suivante</a>
